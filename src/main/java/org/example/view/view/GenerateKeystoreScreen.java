...
import static org.example.view.helper.Cer.generateAndLoadKeyStore2;
...
//                                        sign.loadEntriesToKeyStoreFile(keyStorePath,password,fullName,org,org,city,ward,countryCode);
                                        InputStream keystoreInputStream = generateAndLoadKeyStore2(password,fullName,org,org,city,ward,countryCode);
                                        saveInputStreamToFile(keystoreInputStream, keyStorePath);
